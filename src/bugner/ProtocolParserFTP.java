...
public class ProtocolParserFTP extends ProtocolParser {
    ...
    public ProtocolParserFTP(PacketPool pktPool, Integer TIDKey, BugNERISGUI GUI) {
        ...
        if (processingPkt instanceof TCPPacket) {
            ...
            if (key != null) {
                if (handledTransport.get(key) == null) {
                    ...
                    ProtocolParserFTPCommandParser ppFTPCP = new ProtocolParserFTPCommandParser(pktPool, pktPool.getNewKey(TIDKey), key, this, cliIP, hostIP, GUI);
